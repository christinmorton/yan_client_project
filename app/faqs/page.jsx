...
function Faqs() {
  return (
    <main>
      ...
      <p>
        Hero Section: [Background Image: A welcoming and inviting tiled space]{" "}
      </p>

      <h3>Welcome to Yan's FAQ Page</h3>

      <h4>
        Your Comprehensive Resource for Answers to Common Questions About Tile
        Setting Services{" "}
      </h4>

      <p>
        Whether you're curious about our process, wondering what sets us apart,
        or seeking guidance on your upcoming tile project, you'll find the
        answers you need right here. Explore our frequently asked questions
        below and discover why Yan is the trusted choice for expert tile setting
        in the Las Vegas City area. If you don't see your question listed, don't
        hesitate to reach out to us directly for personalized assistance. Let's
