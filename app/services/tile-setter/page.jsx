...
>
        ...
        <p className="max-w-md mx-auto text-sm text-center mb-4 text-white lg:text-lg lg:text-left lg:mt-0 lg:mx-0">
          Proper tile setting is essential for achieving durable, long-lasting
          results that enhance the beauty and functionality of your space.
        </p>
        <p className="max-w-md mx-auto text-sm text-center mb-4 text-white lg:text-lg lg:text-left lg:mt-0 lg:mx-0">
          With professional expertise, you can ensure precise alignment,
        ...
        <p className="max-w-md mx-auto text-sm text-center  text-white lg:text-lg lg:text-left lg:mt-0 lg:mx-0">
          Trusting your tile installation to an experienced professional like
      ...
      <section className="min-w-full min-h-screen  bg-slate-200">
        ...
        <p className="max-w-md mx-auto text-lg text-center text-picton-blue-400 lg:text-xl lg:text-left lg:mt-0 lg:mx-0">
          <span>Consultation:</span> Yan begins by listening to your vision, discussing design ideas, and assessing the scope of your project to create a tailored plan.
        </p>
        <p className="max-w-md mx-auto text-lg text-center text-picton-blue-400 lg:text-xl lg:text-left lg:mt-0 lg:mx-0">
          <span>Preparation:</span> Proper surface preparation is crucial for ensuring a smooth and level substrate, laying the foundation for flawless tile installation.
        </p>
        <p className="max-w-md mx-auto text-lg text-center text-picton-blue-400 lg:text-xl lg:text-left lg:mt-0 lg:mx-0">
          <span>Installation:</span> Using advanced techniques and premium materials, Yan meticulously lays each tile with precision and care, paying attention to every detail.
        </p>
        <p className="max-w-md mx-auto text-lg text-center text-picton-blue-400 lg:text-xl lg:text-left lg:mt-0 lg:mx-0">
          <span>Finishing Touches:</span> Once the tiles are set, Yan applies grout, seals edges, and performs quality checks to ensure a flawless finish that exceeds your expectations.
        </p>
        </div>
      </section>
